...
def update_enviro():
    ...
    temp = funhouse.peripherals.temperature - 10
    ...
    if USE_FAHRENHEIT:
        funhouse.set_text("{:.1f}{}({:.1f}C)".format(temp, unit, ctemp), temp_label)
    else:
...
def update_cycle():
    global output, last_environment_timestamp, peripheral_state_changed, last_publish_timestamp
